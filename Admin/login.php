...
Monotone Admin Login CSS
  <form  action="process.php" method="POST" id="formu">
    	<div class="admin">
			      <div class="rota">
				        <h1>ADMIN</h1>
        				<input id="username" type="text" name="admin_username" value="" placeholder="Kullanıcı Adı"/><br />
				        <input id="password" type="password" name="admin_password" value="" placeholder="Şifre"/>
