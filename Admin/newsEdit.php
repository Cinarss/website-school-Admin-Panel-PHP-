         ...
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <?php 
                ...
                <input type="hidden" name="eski_yol" value="<?php echo $newsGet['news_image']; ?>">
                <input type="hidden" name="news_id" value="<?php echo $newsGet['news_id']; ?>">

                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" name="newsİmageUpdate" class="btn btn-primary">Güncelle</button>
                </div>
