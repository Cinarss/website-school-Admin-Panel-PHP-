...
<body>
    ...
    <div class="header">
        <div class="header-doner-sermaye-container">
            <div class="container">
                <div class="logo"><img src="images/doner-sermaye.jpg" alt=""></div>
                 <h1>Okulumuzda döner sermaye hizmete girmiş ve faaliyetlerine başlamıştır.</h1>
                 <h2>Buca Nevla Tevfik Karadavut Mesleki ve Teknik Anadolu Lisesi Müdürlüğü</h2>
                 <h3>Döner Sermaye İşletmesi Faaliyetleri</h3>
                 <p>Okulumuzda açılan döner sermaye işletmesi ile Elektrik Elektronik Teknolojisi alanı ile Bilişim Teknolojileri alanında aşağıda belirtilen işlere yönelik malzeme tedariki bakım onarım tadilat revizyon ve taahhüt iş ve işlemleri yapılmaktadır. Gerek malzeme tedariki gerekirse de imalat ve bakım onarım işlemlerinde işbirliği protokolü yaptığımız ve protokol için prensipte anlaştığımız firmalar ve faaliyet alanları aşağıda belirtilmiştir. Buca ilçesindeki tüm okul ve resmi kurumların aşağıda belirtilen iş ve işlemleri okulumuz döner sermayesinden piyasa fiyatlarının altında kar amacı güdülmeden, güvenli bir şekilde yapılarak çalışmaları sağlanacaktır.</p>

                 <h3>Döner Sermaye Üretim Faaliyetleri</h3>

                 <ul>
                     <li>Hidrolik, Pnömatik, elektrohidrolik, elektropnömatik, PLC, Tesisat ve diğer modüller eğitim setleri, imalatı.</li>
                     <li> Elektrik tesisatı bakım onarım işleri.</li>
                     <li>Seramik, Tarım, ahşap işleme, el sanatları, toplumsal e sosyal yaşam merkezleri, tasarım geliştirme ve beceri geliştirme atölyeleri kurmak.</li>
                     <li>Robotik, mikrodenetleyici, arduino kodlama ve algoritma kurma becerisi geliştirme atölyeler kurma, geliştirme kitleri tasarımı ile eğitim setleri imalat ve montajı yapmak.</li>
                     <li>Robotik arduino kodlama başlangıç ve ileri seviye uygulama kitleri imalatı ve eğitimleri.</li>
                     <li>Kompanzasyon panosu tasarımı imalatı, bakım onarım ve tadilat revizyon işleri.</li>
                     <li>PLC ve Oparatör panel programları yazma ve geliştirme işleri.</li>
                     <li>Her türde pano tasarımı imalat ve montaj işleri.</li>
                     <li>Garanti süresi dolan akıllı tahtaların bakım onarım işleri.</li>
                     <li>Yeni bilgisayar toplama ve montaj işlemleri.</li>
                     <li>Bilgisayar bakım onarım işlemleri.</li>
                     <li>Öğrenci geçiş kontrol sistemleri.</li>
                     <li>Yeni BT Laboratuvarı kurma ve montaj işlemleri.</li>
                     <li>Mesleki yeterlilik belgesi için mesleki eğitim işlemleri.</li>
                     <li>Elektrik – Elektronik ve bilişim teknolojileri alanlarında mesleki eğitim işlemleri.</li>
                     <li>Klima bakım onarım ve servis işlemleri.</li>
                     <li>CCTV kamera tedariki ve projesi ve montajı.</li>
                     <li>Network ürünleri tedarik ve montajı.</li>
                     <li>Switch kabinet kablo tedariki ve montajı.</li>
                     <li>Fiber alt yapı malzeme tedariki ve montajı.</li>
                     <li>Okul zil sistemleri tedariki ve montajı.</li>
                     <li>Yangın alarm ve hırsız alarm sistemleri tedariki ve montajı.</li>
                     <li>Konferans salonu projeleri ürün tedariki ve montajı.</li>
                     <li>Fotokopi ve Yazıcı cihazlarının toner dolum ve bakım işleri.</li>
                     <li>Ledli kayan yazı (tarih, saat, sıcaklık göstergeli) tasarım ve montajı.</li>
                     <li>Skorbord imalat ve montajı.</li>
                 </ul>
            </div>
        </div>
    </div>
