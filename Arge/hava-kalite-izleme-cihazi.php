...
<body>
    ...
    <div class="header">
        <div class="header-ata-container">
            <div class="container">
                <div class="logo"><img src="../images/k_28231907_ARGE.jpg" alt=""></div>
                <h1>Ata Mikrobiyal Hava Kalitesi İzleme Cihazı (Hava Örnekleme + Partikül Ölçme Cihazı)</h1>
                <p>Milli Eğitim Bakanlığı Mesleki ve Teknik Eğitim Genel Müdürlüğünün ARGE merkezi olan okullara sağladığı finansman desteği ile ATA MİKROBİYAL HAVA KALİTESİ İZLEME CİHAZI (HAVA ÖRNEKLEME + PARTİKÜL ÖLÇME CİHAZI) projesinde çalışmalar süratle yürütülmektedir. Gıda ve içecek sektörü ile hastanelerdeki diğer temiz oda işlemlerinde ISO VE HACCP uygulamalarına dönük, havadakimikrobiyal yükü belirlemek için kullanılan bu cihazın prototip yapımı, okulun ARGE ekibinin çalışmalarıyla devam etmektedir. Hâlihazırda projenin elektronik devrelerin ve yazılımlarının bir kısmı tamamlanmıştır. Haziran ayı sonunda cihazın bitirilmesi planlanmaktadır. Seri üretime geçilebilecek şekilde tüm hazırlıklar sürdürülmektedir.</p>
                <div class="cihaz"><img src="../images/ata-hava.png" alt=""></div>
            </div>
        </div>
    </div>
