...
<body>
    ...
    <nav id="main-nav" class="nav">
        ...
        <div class="header">
            <div class="header-otomasyon-container">
                <div class="container">
                    <div class="baslik"><h1>Endüstriyel Otomasyon Teknolojileri Alanı</h1></div>

                    <p>Endüstride otomatik üretim yapan makinelerin bakımı, onarımı, programlanması ve temel olarak imalatı, otomasyon sistemlerinin ağ yapılarını kullanarak üretimin ölçümü, izlenmesi ve denetlenmesi için donanım ve yazılım işlemlerini yapma yeterliklerini kazandırmaya yönelik eğitim ve öğretim verilen alandır.</p>
                    <br>
                    <p>Endüstriyel otomasyon; robot teknolojisinin her alanında yaygın şekilde kullanılmaktadır. Günümüzde teknolojinin bir gereği hatta zorunluluğu olmuştur. Ürün tasarımı, sistem dinamiği ve akıllı kontrol, üretim süreçlerinin gözlenmesi, modellenmesi ve kontrolü, kuvvet elektroniği, mikro sistem tasarımı ve uygulamaları, endüstriyel kontrol tasarımı, algılayıcılar ve robot sistemleri, görüntü işleme, sistemler arası iletişim ağları, yapay zekâ ve sanal gerçeklik gibi konuları içermesi nedeni ile savunma sanayii, otomotiv ve tekstil sektörleri için önemli meslek dallarının başında gelir.</p>
                    <br>

                    <h3>Alanın Altında Yer Alan Dallar</h3>
                    

                    <p>Okulumuzda Mekatronik dalında eğitim verilmektedir.</p>
                    <br>
                    <p><strong>Mekatronik dalı</strong>, akıllı makinelerin, ergonomik ve faydalı ürünlerin tasarlanarak üretilmesi için Makine Teknolojileri, Elektrik-Elektronik Teknolojileri ve Bilgisayar Teknolojilerinin bir birleşimi olarak ortaya çıkmıştır. Kısaca, <strong>Mekatronik dalı</strong> ; makine, elektrik-elektronik ve bilgisayar yazılım teknolojilerinin bir makine veya ürün üzerinde birleşerek bütünleşmesini sağlayan bir mühendislik dalı olarak tanımlanabilir.</p>
                    <br>
                    <p>Mekatronik bir ürün, mekanik gücü oluşturmak için motor sistemleri, oluşan gücü aktarmak için mekanik sistemler, değişimleri algılamak için sensörler, sistemin kontrolü için mikroişlemci ve tüm sistem veya makineyi merkezi veya dağınık yapıda denetleyebilen bilgisayar programlarından oluşmaktadır.</p>
                </div>
            </div>
        </div>
