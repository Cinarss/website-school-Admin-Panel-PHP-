...
<body>
    ...
    <nav id="main-nav" class="nav">
        ...
        <div class="container">            
            ...
            <div class="header">
                <div class="header-ders-container">
                    <div class="container">
                        <h3>Genel Bilişim Teknolojileri alanı ortak dersleri göreceksiniz. Ders içerikleri aşağıdaki tablodan inceleyebilirsiniz.</h3>

                        <div class="baslik">9.Sınıf</div>
                        <div class="tablo">
                            ...
                            <tr>
                                <td>Mesleki Gelişim Atölyesi</td>
                                <td>2</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Bilgisayarlı Tasarım Uygulamaları</td>
                                <td>2</td>
                            </tr>
                        </table>

                        <div class="baslik">10.Sınıf</div>
                        <h3>10. sınıfa geçtiğinizde YAZILIM GELİŞTİRME DALI VE AĞ İŞLETMENLİĞİ VE SİBER GÜVENLİK DALI dallarından birini seçmeniz gerekmekte olup ders içerikleri aşağıdaki tablodan inceleyebilirsiniz.</h3>
                        ...
                        <table class="ag">
                            <tr>
                                <th colspan="2">Yazılım Geliştirme</th>
                            </tr>
                            <tr>
                            <th>Ders</th>
                            <th>Saat</th>
                    ...
                    <table class="ag">
                        <tr>
                            <th colspan="2">Ağ İşletmenliği ve Siber Güvenlik</th>
                        </tr>
                        <tr>
                        <th>Ders</th>
                        <th>Saat</th>
                    ...
                    <tr>
                        <td>Ağ Sistemleri ve Anahtarlama</td>
                        <td>10</td>
                    </tr>
                ...
                <div class="baslik">11.Sınıf</div>
                <h3>10. sınıfta seçtiğimiz yazılım geliştirme veya ağ işletmenliği ve siber güvenlik dallarından hangisini seçtiysek o dalda derslerimizi görmeye devam ediyoruz. Ders içerikleri aşağıdaki tablodan inceleyebilirsiniz.</h3>
                ...
                <tr>
                    <td>Web Tabanlı Uygulama Geliştirme</td>
                    <td>8</td>
                </tr>
                ...
                <table>
                    <tr>
                        <th colspan="2">Ağ İşletmenliği ve Siber Güvenlik (11.Sınıf)</th>
                    </tr>
                    <tr>
                    <th>Ders</th>
                    <th>Saat</th>
                ...
                <tr>
                    <td>Ağ Sistemleri ve Yönlendirme</td>
                    <td>8</td>
                </tr>
                
                <tr>
                    <td>Siber Güvenlik Temlleri</td>
                    <td>5</td>
                </tr>

                <tr>
                    <td>Sunucu İşletim Sistemleri</td>
                    <td>4</td>
                </tr>
                
            </table>
            <h3 style="color: #000;opacity: .7;"><strong style="opacity: 1;">Not:</strong>Bu derslerin dışında seçmeli meslek dersleri de eklenmektedir. Bu dersleri sayfanın en sonunda inceleyebilirsiniz.

            </h3>

            <div class="baslik">12.Sınıf</div>
            <h3>9. 10. ve 11. Sınıfların akademik ders ortalaması 70 ve üzerinde olan öğrenciler 11. Sınıfın sonunda 40 günlük stajlarını tamamlayarak eğitimde 12. sınıfta Akademik Destek dersleri almak için Anadolu Teknik Programına geçebilirsiniz.</h3>
            <br>
            <h3>Anadolu Meslek Programı ile devam edenler;</h3>
            ...
            <tr>
                <td>İşletmelerde Mesleki Eğitim</td>
                <td>24</td>
            </tr>
            
            <tr>
                <td>Sertifika Dersleri</td>
                <td>7</td>
            </tr>
            
        </table>

        <h1>Sertifika Dersleri Tablosu:</h1>
        <div><img src="../../images/sertf.png" alt=""></div>
        <br>

        <h1>Seçmeli Meslek Dersleri Tablosu</h1>
        <div><img src="../../images/secmeli.png" alt=""></div>
        <h3>(*)Millî Eğitim Bakanlığı Ortaöğretim Kurumları Yönetmeliği uyarınca yılsonu başarı puanı ile başarılı sayılamayacak derslerdir.</h3>
        <br>

        <div class="akademik"><img src="../../images/12-akademik.png" alt=""></div>
        <h3>Alanımıza  ait bilgisayar laboratuarımız bulunmaktadır. Bilgisayar laboratuarımızda network alt yapısı kurulu olup internet ortamına girişi sağlanmıştır. Derslerde her öğrenci, bir bilgisayarda çalışabilecek durumdadır.</h3>
