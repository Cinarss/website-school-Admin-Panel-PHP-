...
<body>
    ...
    <div class="header">
        <div class="header-elektrik-container">
            <div class="container">
                <div class="baslik"><h1>Elektrik-Elektronik Tek. Alanı</h1></div>

                <p>Elektrik-Elektronik sektörü, küresel düzeyde hızla değişen pazar ve rekabet koşulları nedeni ile sürekli ve dinamik bir gelişim içindedir. Bu özellikleri nedeni ile Elektrik-Elektronik Alanı, stratejik bir sanayi olarak ülkelerin yakın ilgisini çekmekte, özel planlamalar yapılmaktadır. Özellikle hızla küreselleşmekte olan bu sektörde rekabet büyük yoğunluk kazanmakta ve sanayileşmiş ülkeler bu sektörün korunması ve rekabet gücünün geliştirilmesi için özel politikalar uygulamaktadırlar. Elektrik Elektronik  tüm Üretim ve yaşam alanlarının ana vazgeçilmez en temel parçasıdır.</p>
                <br>
                ...
                <br>
                <h2>Alanın Altında Yer Alan Dallar</h2>
                <h3>Elektrik Tesisatları ve Pano Montörlüğü</h3>
                <p>Elektrik-elektronik sektöründe; meslek elemanının sahip olması gereken, bina içi ve dışı elektrik tesisatının ve tüm elektrik panolarının kurulumunu ve bakım onarımını yapma yeterliklerini kazandırmaya yönelik eğitim ve öğretim verilen daldır.</p>
                <br>
                <h3>Endüstriyel Bakım Onarım</h3>
                <p>Endüstriyel bakım ve onarım elemanının sahip olması gereken, fabrika, atölye vb. işletmelerdeki  elektrik elektronik sistemlerin bakım ve onarımını yapma yeterliklerini kazandırmaya yönelik eğitim ve öğretim verilen daldır.</p>
                <br>
                <h3>Güvenlik Sistemleri</h3>
                <p>Binalara ait yangın algılama, CCTV (kapalı devre güvenlik sistemleri), soygun ihbar alarm, geçiş kontrol sistemleri ile ilgili kurulum, bakım ve onarım işlemleri yapma yeterliklerini kazandırmaya yönelik eğitim ve öğretim verilen daldır.</p>
                <br>
                <h3>Görüntü ve Ses Sistemleri</h3>
                <p>Teknik servis elemanının sahip olması gereken, görüntü, ses ve ışıklandırma sistemlerinin kurulum, bakım ve onarım işlemlerini yapma yeterliliklerini kazandırmaya yönelik eğitim veren daldır.</p>
            </div>
        </div>
    </div>
