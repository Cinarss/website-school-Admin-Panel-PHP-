...
<body>
    ...
    <nav id="main-nav" class="nav">
        ...
        <div class="header">
            <div class="header-ogrenci-container">
                <div class="container">
                    <h1>Öğrenci İşleri</h1>

                    <ul>
                        <a href="/dosyalar/06091502_SINIF-PROGRAMLARI.pdf" target="_blank" class="class"><li>Sınıf Programları</li></a>
                        <a href="" class="class" id="dilek"><li>Dilekçeler</li></a>
                    </ul>

                    <div class="dilek">
                        <ul>
                            <a href="./dosyalar/29011910_mazeretzn.docx" target="_blank"><li>Mazeret İzin Dilekçesi</li></a>
                            <a href="./dosyalar/29011911_tasdiknameıstemedilekcesi.docx" target="_blank"><li>Tasdikname Dilekçesi</li></a>
                            <a href="../dosyalar/29011911_tasdiknamekayıpdilekcesi.docx" target="_blank"><li>Tasdikname Kayıp Belgesi</li></a>
                            <a href="../dosyalar/29011911_learasizindilekesi.docx" target="_blank"><li>Öğle Arası İzin Dilekçesi</li></a>
                            <a href="../dosyalar/29011910_nakldlekes.docx" target="_blank"><li>Nakil Dilekçesi</li></a>
                        </ul>
                    </div>
                </div>
            </div>
