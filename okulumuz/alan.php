...
<body>
    ...
    <div class="header">
        <div class="header-alan-container">
            <div class="container">
                <ul>
                    <a href="../okulumuz/alanlar/bilisim-tek-alan.php"><li>Bilişim Tek. Alanı</li></a>
                    <a href="../okulumuz/alanlar/elektrik-elektronik-alan.php"><li>Elektrik-Elektronik Tek. Alanı</li></a>
                    <a href="../okulumuz/alanlar/otomasyon-tek-alan.php" class="endus"><li >Endüstriyel Otomasyon Tek. Alanı</li></a>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="footer">
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="map">
                        <a href="https://goo.gl/maps/UFzqJ4P1bChndR6k9"><img src="/okul-websiteokul-website/images/footer-map.png" alt=""></a>
                    </div>
                    <div class="eposta">
