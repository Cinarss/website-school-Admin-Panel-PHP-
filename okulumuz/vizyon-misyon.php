    ...
    <nav id="main-nav" class="nav">
        ...
        <div class="header">
            <div class="vizyon-misyon-container">
                <div class="container">
                    <div class="baslik"><h1>Vizyonumuz-Misyonumuz</h1></div>

                    <div class="misyon">
                        <h1>MİSYONUMUZ</h1>
                        <p>Bugünün ve geleceğin ihtiyaçları ışığında; milli ve manevi değerlere bağlı ve bu değerleri çağdaş düşüncelerle destekleyebilen, <br>
                            teknolojiyi en iyi şekilde kullanabilen, alanında mesleki bilgiyi, beceriyi kazanmış,
                            <br> emeğe saygı duyan, kendine güvenen nitelikli insan gücünü oluşturacak fertleri yetiştirmektir. </p>
                        <br><br>
                    ...
                    <div class="vizyon">
                        <h1>VİZYONUMUZ</h1>
                        <p>Sosyal ve kültürel alanda örnek, mesleki ve teknik alanda öncü, çağdaş ve dinamik bir eğitim kurumu olmak. </p>
                    </div>
                    <br><br>

                    <div class="temel-ilke">
                        <h1>TEMEL İLKE VE DEĞERLERİMİZ</h1>
                        <ul>
                            <li>Atatürk ilke ve inkılâplarını esas alırız.</li>
                            <li>Öğrencilerimizin geleceğinin bizim geleceğimiz olduğuna inanırız.</li>
                            <li>Okulumuzda her öğrencinin gelişmesi için ortam hazırlarız.</li>
                            <li>Başarının takım çalışmasıyla yakalanacağına inanırız.</li>
                            <li>Değişimin ve sürekli gelişmenin önemine inanırız.</li>
                            <li>Öğrenci, veli ve toplum beklentilerine odaklı çalışırız.</li>
                            <li>Ortak aklı kullanarak kararlar alırız.</li>
                            <li>Fırsat eşitliğini okulda yaşatırız.</li>
                            <li>Eğitimde kaliteyi ön planda tutarız.</li>
                            <li>Eğitim ve iletişim yoluyla verimliliği ve fırsatları artırmayı hedefleriz.</li>
                            <li>Örgün eğitimde açıklık ve iş birliğine açık yöntemleri destekleme,</li>
                            <li>Okul çalışanlarının performansı hakkında bilgi toplama,</li>
                            <li>Kurumsal ve bireysel yeterliliklerde elde edilen gelişmeleri değerlendirme,</li>
                            <li>Bölgedeki en iyi okulun performansını analiz etme,</li>
                            <li>Yasal, toplumsal ve çevresel konuları izleme ve değerlendirme,</li>
                            <li>Hedef kitlenin, eğitim çalışanlarının, işbirliği yapılan kurumların ve diğer paydaşlar ile toplumun okuldan temel</li>
                            <li>Okulun içerisinde yer aldığı "eğitimin hizmet alanı ve ilgili hedef kitleye" ilişkin bilgilerin toplanması.</li>
                        </ul>
                    </div>
