...
<body>
    ...
    <nav id="main-nav" class="nav">
        ...
        <div class="header">
            <div class="ogretmenler-container">
                
                <div class="container">
                    <h1>ÖĞRETMENLERİMİZ</h1>
                    <ul class="teach">
                        
                        <a href="ogretmenler/matematik.php"><li><i class="fa-solid fa-ruler"></i>&nbsp; Matematik</li></a>
                        <a href="ogretmenler/bilisim-tek.php"><li><i class="fa-solid fa-desktop"></i>&nbsp; Bilişim Tek.</li></a>
                        <a href="ogretmenler/biyoloji.php"><li><i class="fa-solid fa-dna"></i>&nbsp; Biyoloji</li></a>
                        <a href="ogretmenler/cografya.php"><li><i class="fa-solid fa-earth-africa"></i>&nbsp; Coğrafya</li></a>
                        <a href="ogretmenler/din-kuluturu-ve-ahlka-bilgisi.php"><li><i class="fa-solid fa-book-quran"></i>&nbsp; Din Kültürü ve Ahlak Bilgisi</li></a>
                        <a href="ogretmenler/elektrik-elektronik.php"><li><i class="fa-solid fa-bolt"></i>&nbsp; Elektrik-Elektronik Tek.</li></a>
                        <a href="ogretmenler/elektrik-elektronik.php"><li><i class="fa-solid fa-robot"></i>&nbsp; Endüstriyel Otomasyon Tek.</li></a>
                        <a href="ogretmenler/felsefe.php"><li><i class="fa-solid fa-brain"></i>&nbsp; Felsefe</li></a>
                        <a href="ogretmenler/fizik.php"><li><i class="fa-solid fa-square-root-variable"></i>&nbsp; Fizik</li></a>
                        <a href="ogretmenler/gorsel.php"><li><i class="fa-solid fa-palette"></i>&nbsp; Görsel Sanatlar</li></a>
                        <a href="ogretmenler/turk-dili-ve-edebiyati.php"><li><i class="fa-solid fa-book-open"></i>&nbsp; Türk Dili ve Edebiyatı</li></a>
                        <a href="ogretmenler/ingilizce.php"><li><i class="fa-solid fa-graduation-cap"></i>&nbsp; İngilizce</li></a>
                        <a href="ogretmenler/kimya.php"><li><i class="fa-solid fa-flask"></i>&nbsp; Kimya</li></a>
                        <a href="ogretmenler/muzik.php"><li><i class="fa-solid fa-music"></i>&nbsp; Müzik</li></a>
                        <a href="ogretmenler/rehber.php"><li><i class="fa-solid fa-user-group"></i>&nbsp; Rehberlik</li></a>
                        <a href="ogretmenler/tarih.php"><li><i class="fa-solid fa-book"></i>&nbsp; Tarih</li></a>
                    </ul>
