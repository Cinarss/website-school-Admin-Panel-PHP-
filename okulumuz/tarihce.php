        ...
        <div class="header-tarihce">
            <div class="header-container">
                <div class="container">
                    ...
                    <div class="baslik"><h1>Tarihçe</h1></div>

                    <p>&nbsp; &nbsp; &nbsp;Okulumuz 2012/2013 eğitim öğretim yılında ilk kez Endüstri Meslek Lisesi programında 9. Sınıf öğrencilerine eğitim-öğretim hizmeti vermeye başlamıştır.</p>
                    <p>&nbsp; &nbsp;2013/2014 eğitim öğretim yılında, Anadolu Teknik Lisesi Bilişim Teknolojileri ve Endüstriyel Otomasyon Alanlarında 9. Sınıf, Endüstri Meslek Lisesinde ise ElektrikElektronik Teknolojileri Alanında 10. Sınıflarda öğrenci yetiştirmeye devam etmiştir.</p>
                    <p>&nbsp; &nbsp;2014/2015 Eğitim-öğretim yılı itibariyle ise okul adı Milli Eğitim Bakanlığı tarafından Mesleki ve Teknik Anadolu Lisesine dönüştürülmüştür. Halen okulumuzda Endüstri Meslek, Anadolu Meslek, Teknik ve Anadolu Teknik programlarında eğitim öğretim faaliyetleri yürütülmektedir.</p>
                    <p>&nbsp; &nbsp;Necla Tevfik Karadavut Mesleki ve Teknik Anadolu Lisesi kurulduğu günden bu yana öğrencilerine en üst düzeyde eğitim-öğretim hizmeti sağlayan personeli ile; öncelikle İzmir genelinde en yetkin ve modern eğitim standardını yakalamak, sonrasında ise Türkiye genelinde sayılı okullar arasında yerini almak üzere çalışmalarına devam etmektedir.</p>
                </div>
            </div>
        </div>
