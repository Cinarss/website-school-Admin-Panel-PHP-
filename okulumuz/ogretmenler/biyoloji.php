        ...
        <div class="container">            
            <ul>
                <div class="side_bar_logo">    
                    ...
                    <li class="drop"><a href="../../index.php">Okulumuz &nbsp; <i class="fa fa-caret-down"></i></a>
                    ...
                    <li class="drop"><a href="../../index.php">Basında Biz &nbsp; <i class="fa fa-caret-down"></i></a>
                        <div class="drop-content">
                    ...
                    <li class="drop"><a href="../../index.php">Mesem &nbsp; <i class="fa fa-caret-down"></i></a>
                    <div class="drop-content">
                    ...
                    <li class="drop"><a href="../../index.php">ARGE Merkezi &nbsp; <i class="fa fa-caret-down"></i></a>
                    <div class="drop-content">
                    ...
                    <li class="drop"><a href="../../index.php">Proje Okulu &nbsp; <i class="fa fa-caret-down"></i></a>
                    <div class="drop-content">
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="eposta">
                        ...
                        <a href="../../index.php">e-Posta Göndermek İçin Tıklayın</a>
                    </div>
                </div>
            </div>
