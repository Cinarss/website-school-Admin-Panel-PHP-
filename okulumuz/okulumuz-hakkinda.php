            ...
            <div class="container">
                    ...
                    <ul class="okul-nav">
                        ...
                        <div class="okul-table ">
                            <li><strong>Vizyon: </strong>Bu okulda okuyan mesleğini ve geleceğini kazanır.</li>
                            <li><strong>Misyon: </strong>Öğrencilerimizin, iş piyasasında aranan niteliklere sahip olmasını sağlamak için sektör ile birlikte çalışarak, nitelikli ara eleman yetiştirmek.</li>
                            <li><strong>Saatler: </strong>08:40-17:10</li>
                            <li><strong>Isınma: </strong>Kalorifer</li>
                            <li><strong>İnternet Bağlantısır: </strong>Fatih Projesi Fiber İnternet</li>
                        </div>

                        <div class="contact-table d-none">
                            <li><strong><i class="fa-solid fa-phone-flip"></i> &nbsp; Telefon: </strong>  0 (232) 260 10 60</li>
                            <li><strong><i class="fa-solid fa-print"></i> &nbsp; Belge geçer: </strong>(232) 260 1062</li>
                            <li><strong><i class="fa-solid fa-envelope-open-text"></i> &nbsp; Eposta: </strong><a href="#">Göndermek için tıklayınız</a></li>
                            <li><strong><i class="fa-solid fa-globe"></i> &nbsp; WEB: </strong><a href="#">https://ntkmtal.meb.k12.tr</a></li>
                            <li><strong><i class="fa-solid fa-location-dot"></i> &nbsp; Adres: </strong>İnönü Mahallesi 677/5. Sk. No58 35380 Buca/İzmir, Türkiye</li>
                        </div>

                        <div class="mevcut-durum  d-none">
                            <li><strong><i class="fa-solid fa-chalkboard-user"></i>&nbsp; Öğretmen: 67</strong></li>
                            <li><strong><i class="fa-solid fa-graduation-cap"></i>&nbsp; Öğrenci: 671</strong></li>
                            <li><strong><i class="fa fa-building"></i>&nbsp; Derslik: 24</strong></li>
                            <li><strong><i class="fa-solid fa-microphone"></i>&nbsp; Çok Amaçlı Salon: 1</strong></li>
                            <li><strong><i class="fa-brands fa-intercom"></i>&nbsp; Mesleki Uygulama Labaratuvarı: 10</strong></li>
                            <li><strong><i class="fa-solid fa-flask"></i>&nbsp; Kimya Labaratuvarı: 1</strong></li>
                            <li><strong><i class="fa-solid fa-flask"></i></i>&nbsp; Fizik Labaratuvarı: 1</strong></li>
                            <li><strong><i class="fa-solid fa-book-open-reader"></i>&nbsp; Kütüphane: 1</strong></li>
                            <li><strong><i class="fa-solid fa-book-blank"></i>&nbsp; Kütüphane Kitap Sayısı: 366</strong></li>
                            <li><strong><i class="fa-solid fa-utensils"></i>&nbsp; Yemekhane: 1</strong></li>
                        </div>

                        <div class="ulasim d-none">
                            <li><strong><i class="fa-solid fa-location-dot"></i>&nbsp; Yerleşim Yeri - Semt Garajı, Otokent ve Zikirtepe camisi yakınındadır.</strong></li>
                            <li><strong><i class="fa-solid fa-location-dot"></i>&nbsp; Adres - İnönü Mahallesi 677/5. Sk. No58 35380 Buca/İzmir, Türkiye</strong></li>
                            <li><strong><i class="fa-solid fa-train-subway"></i>&nbsp; Ulaşım İZBAN ile : Semt garajı durağına 7-8 dk. yürüyüş mesafesi ESHOT ile : 107 hat numaralı otobüs ile saha durağı okulumuzun önündedir. OTOMOBİL ile : Otokent C kapısı karşı çaprazında bulunan sokaktan girilerek 300 metre.</strong></li>
                            <li><strong><i class="fa-solid fa-map-pin"></i>&nbsp; İl/İlçe Merkezine Uzaklık Buca ilçe merkezine 8 km.</strong></li>
                        </div>
