...
<body>
    ...
    <div class="header">
        <div class="header-mesleki-container">
            <div class="container">
                <div class="logo"><img src="../images/k_26221556_Mesem_LOGO.jpg" alt=""></div>
                <div class="baslik"><h1>Mesleki Eğitim Merkezi</h1></div>
                <p>Okulumuzda 2019-2020 Eğitim Öğretim yılından itibaren Mesleki Eğitim Programı uygulanmaktadır.</p>
                <br>
                <p>En az ortaokul mezunu olup zorunlu eğitim çağında olanlar ve on dokuz yaşından gün almış olanlar da yaşlarına ve eğitim seviyelerine uygun olarak çıraklık eğitimine alınabilir.</p>
                <br>
                <p>Mesleki eğitim merkezlerinde okuyan öğrencilere 11. sınıfın sonunda Kalfalık Belgesi, 12. sınıfın sonunda ise Ustalık Belgesi verilecektir.</p>
                <br>
                <p>2019-2020 eğitim-öğretim yılı itibarı ile mesleki eğitim merkezi öğrencileri lise diploması alabilecektir.</p>
                <br>
                <p>3308 sayılı Mesleki Eğitim Kanunun 10 uncu maddesi kapsamında Mesleki eğitim merkezine kayıt olacaklar için aşağıdaki şartlar aranır.</p>
                    <h1 class="onemli">!!!!!!!</h1>
                    <p>En az ortaokul veya imam-hatip ortaokulu mezunu olmak.</p>
                    <br>
                    <p>Bünyesi ve sağlık durumu gireceği mesleğin gerektirdiği işleri yapmaya uygun olmak, şartları aranmakta olup bununla birlikte 3308 sayılı Kanun kapsamında bulunan Alan ve dalda eğitim verilebilecek standartlara uygun atölye veya işyeri ile usta öğretici belgesine sahip eğitici olması gerekmektedir. Bu şartlarla birlikte Mesleki Eğitim Merkezi Programı (MEMP) uygulayan mesleki ve teknik ortaöğretim okullarına müracaat edip sözleşme imzalayanlar çırak öğrenci olabilmektedirler.</p>
                    <h3>Çıraklık Kayıt Evrakları</h3>

                    <ul>
                        <li>Öğrenim belgesi fotokopisi</li>
                        <p>(Öğrencinin durumuna göre Diploma, Tasdikname, Açık Lise öğrenci belgesi)</p>
                        <br>
                        <li>Çırak Öğrenci Kayıt Taahhütnamesi</li>
                        <p>(Okuldan alınacak. Çırak öğrenciden sorumlu usta öğretici ve işletme yetkilisi tarafından doldurulup imzalanacaktır. İşletme yetkilisi ve usta öğreticinin aynı kişi olması durumunda İşletme yetkilisi tek taraflı olarak imzalayacaktır.)</p>
                        <br>
                        <li>Çırak öğrenciden sorumlu kişinin ustalık ve usta öğreticilik belgesinin fotokopisi.</li>
                        <p>(Usta öğreticilik belgesinde alan ve dal yazması durumunda sadece usta öğreticilik belgesi getirilir.)</p>
                        <br>
                        <li>Sağlık ve fiziki durumunun mesleğinin gerektirdiği işleri yapmaya uygun olduğunu gösteren sağlık raporu.</li>
                        <br>
                        <li>Kayıt olacak öğrencinin Kimlik fotokopisi</li>
                        <br>
                        <li>SGK Müstehaklık Sorgulama Belgesi. (SGK Bürolarından alınacak).</li>
                        <br>
                        <li>İş yerinin İş Sağlığı ve Güvenliği Hizmet alım Sözleşmesi Fotokopisi</li>
                        <br>
                        <li>4x6 Ebatlarında 2 adet Vesikalık Fotoğraf</li>
                    </ul>
            </div>
        </div>
    </div>
