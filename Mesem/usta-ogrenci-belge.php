...
<body>
   ...
   <div class="header">
       <div class="header-kalfalik-container">
           <div class="container">
               <div class="logo"><img src="../images/k_26221556_Mesem_LOGO.jpg" alt=""></div>

               <div class="baslik">
                   <h1>Usta Öğreticilik Belgesi</h1>
               </div>
               <p>Ustalık veya işyeri açma belgesine sahip olanlar ile en az ön lisans seviyesinde mesleki eğitim almış olanlar, Okulumuza Usta Öğreticilik kursu için başvuru yapabilirler. Kursu başarı ile tamamlayanlara usta öğreticilik belgesi verilir. Usta öğreticilik belgesi; ustalık belgesi, işyeri açma belgesi veya en az ön lisans diploması ile birlikte kullanılır.</p>
               <div class="basvuru">
                   <a href="../dosyalar/26224817_Usta_OYgYretici_BasYvuru_Formu.pdf">Usta Öğretici Başvuru Formu</a>
