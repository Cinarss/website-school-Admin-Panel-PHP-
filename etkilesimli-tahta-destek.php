...
<body>
    ...
    <div class="header">
        <div class="header-tahta-container">
            <div class="container">
                <div class="logo"><img src="images//k_16075650_destek.jpg" alt=""></div>
                <h1>Okulumuz, Fatih Projesi kapsamında etkileşimli tahtaların bakım ve onarım <strong>DESTEK NOKTASI</strong> olarak belirlendi.</h1>

                <p>Mesleki ve Teknik Eğitim Genel Müdürlüğü ile Yenilik ve Eğitim Teknolojileri Genel Müdürlüğü arasında Fatih Projesi 1. ve 2. faz kapsamında daha önce alımı yapılmış ve garanti sürelerini doldurmuş etkileşimli tahtaların, Mesleki ve Teknik Eğitim Anadolu liseleri tarafından bakım ve onarımlarının sağlanmasını içeren protokol imzalanmıştı. Protokol ile meslek liselerinin döner sermaye kapasitesinin geliştirilmesinin ve öğrencilerin iş başında öğrenmelerinin hedeflendiği vurgulanmıştı.</p>
                <br>
                <p>Söz konusu protokol ile okulumuz bir çok meslek lisesi içinden  Destek Noktası olarak belirlendi. Artık Buca Necla Tevfik Karadavut Mesleki ve Teknik Anadolu Lisesi olarak etkileşimli tahtaların bakım ve onarımları yapabilmekteyiz.</p>
                <br>
                <p>Böylece okulumuzun döner sermaye kapasitesinin geliştirilmesi, öğrencilerin üretirken ve tamir ederken iş başında öğrenmelerinin sağlanması ile var olan "fabrika okullar" vizyonunun daha da güçlendirilmesini hedeflemekteyiz.</p>
                <br>
                <p>Protokol kapsamında etkileşimli tahtaların tamiratlarının yanı sıra Destek Noktası olan okulların atölye ve laboratuvarlarının donatılması, öğretmenlerine ihtiyaç duydukları hizmet içi eğitimlerin verilmesi, öğrencilerine beceri eğitimi/stajlarının yaptırılması okulumuza yepyeni değerler katmaktadır.</p>
